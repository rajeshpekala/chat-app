  ...
  return (
    <div className="bg-slate-800">
      <div className="flex justify-center ">
        <div className="flex justify-center  items-center p-6 border border-black bg-blue-500 rounded-3xl mt-24 mb-16 p-1/2 w-9/10">
      ...
      <div className="flex justify-center">
        <div className="flex justify-center  items-center p-6 border border-black bg-blue-300 rounded-3xl my-2 p-1/2 w-9/10">
          <h1 className="text-2xl font-bold text-white flex flex-col">
